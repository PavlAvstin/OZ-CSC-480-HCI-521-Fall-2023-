...
public class PopulationData {
    public void populateDataBase(){
        ...
        db.createRating("Animal prowess", "7", "7", "David", movie4.get().getId(), "public");
        db.createRating("Dirty rat", "5", "5", "David", movie4.get().getId(), "public");
        ...
        db.createRating("Hottest animated character", "10", "10", "David", movie5.get().getId(), "public");
        ...
        db.createRating("Hottest animated character", "10", "10", "David", movie6.get().getId(), "public");
        ...
        db.createRating("Hottest animated character", "10", "10", "David", movie10.get().getId(), "public");
        ...
        db.createRating("Pretty Clothes", "6", "6", "David", movie15.get().getId(), "public");
